...
const ServicesLayout = () => {
  return (
    ...
    <div className="container mx-auto flex flex-col lg:flex-row p-6 gap-6">
      ...
      <div className="lg:w-1/3 sticky top-6 bg-gradient-to-b from-blue-500 to-blue-700 text-white p-6 rounded-xl shadow-lg">
        ...
        <button className=" bg-logo-dark-blue  px-6 py-3 rounded-md hover:bg-gray-100 transition">
